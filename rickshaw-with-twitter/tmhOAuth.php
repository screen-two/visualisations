  ...
  public function __construct($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'user_secret'                => 'AcKfb0CjRi3mun0dpFQAhubh4Br8hLmlwac8G4IDJ',
        'force_nonce'                => false,
		...
		//****I have set this to false - There's a problem with the certs I can't figure out right now. This is a security issue needs to be fixed!!!****
